          ...
          <View style={styles.cleanCardHeader}>
            ...
            {selectedProfile && dietaryAnalysis && (
              <View style={[
                ...
                { backgroundColor: dietaryAnalysis.riskLevel === 'low' ? '#4CAF50' :      // Green - Compatible
                                 dietaryAnalysis.riskLevel === 'medium' ? '#FF9800' :    // Orange - Risky
                                 '#F44336' }                                              // Red - High Risk/Incompatible
              ]}>
                    ...
                    <View 
                      style={[
                        ...
                        { 
                          ...
                          backgroundColor: dietaryAnalysis.riskLevel === 'low' ? '#4CAF50' : 
                                          dietaryAnalysis.riskLevel === 'medium' ? '#FF9800' : '#F44336'
                        }
                      ]} 
                    />
                  </View>
